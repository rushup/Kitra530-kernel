...
#define ST_LSM6DSX_REG_TAP_Z_EN__MASK	BIT(1)
#define ST_LSM6DSX_REG_TAP_Y_EN_MASK	BIT(2)
#define ST_LSM6DSX_REG_TAP_X_EN_MASK	BIT(3)
#define ST_LSM6DSX_REG_TILT_EN_MASK		BIT(5)
#define ST_LSM6DSX_REG_PEDO_EN_MASK		BIT(6)
#define ST_LSM6DSX_REG_6D_THS_CFG_ADDR			0x59
#define ST_LSM6DSX_REG_TAP_THS		GENMASK(0,4)
#define ST_LSM6DSX_REG_SIXD_THS_MASK   GENMASK(6, 5)
#define ST_LSM6DSX_REG_D4D_EN_MASK   BIT(7)
#define ST_LSM6DSX_REG_INT_DUR2_ADDR	0x5a
#define ST_LSM6DSX_REG_SHOCK_MASK	GENMASK(1, 0)
#define ST_LSM6DSX_REG_QUIET_MASK	GENMASK(3, 2)
#define ST_LSM6DSX_REG_DUR_MASK		GENMASK(7, 4)
#define ST_LSM6DSX_REG_WAKE_UP_THS_ADDR		0x5b
#define ST_LSM6DSX_REG_WK_THS_MASK		GENMASK(5, 0)
#define ST_LSM6DSX_REG_INACTIVITY_MASK		BIT(6)
#define ST_LSM6DSX_REG_SINGLE_DOUBLE_TAP_MASK	BIT(7)
#define ST_LSM6DSX_REG_FREE_FALL_ADDR	0x5d
#define ST_LSM6DSX_REG_FF_THS_MASK		GENMASK(2, 0)
#define ST_LSM6DSX_REG_FF_DUR_MASK		GENMASK(7, 3)
...
void st_lsm6dsx_read_event_config(struct iio_dev *indio_dev,
...
static int st_lsm6dsx_init_device(struct st_lsm6dsx_hw *hw)
{
	...
	/* latch interrupts */
	err = st_lsm6dsx_write_with_mask(hw, ST_LSM6DSX_REG_TAP_CFG_ADDR,
