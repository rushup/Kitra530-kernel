...
#define ST_PRESS_LPS22HB_PW_MASK		0x70 //same as odr
...
#define ST_PRESS_LPS22HB_DRDY_IRQ_INT2_MASK	0x10 //non esiste
#define ST_PRESS_LPS22HB_MULTIREAD_BIT		true //
#define ST_PRESS_LPS22HB_OUT_XL_ADDR		0x28 //
#define ST_TEMP_LPS22HB_OUT_L_ADDR		0x2b //
	...
	},
	{
		...
		.odr = {
			...
			.odr_avl = {
				...
				{ 70, ST_PRESS_LPS22HB_ODR_AVL_75HZ_VAL, },
			},
		},
		.pw = {
